...
d_cursor.execute("SELECT size,difficulty,numtx,coinagedestroyed,mint,timestamp,height FROM blocks WHERE timestamp >= %s ORDER BY height ASC;", (chain_start, ))
...
for x in get:
        ...
        if timestamp <= one_day:
                ...
                print avg_size,avg_diff,avg_blocks,"avg_numtx->",avg_numtx,avg_cd,avg_mint,num_blocks,height
                ...
                one_day = 1435982400 + w # JULY 4th timestamp, the day pos blocks started
                num_blocks = 0
                avg_size = 0.0
                avg_diff = 0.0
                avg_blocks = 0
